...
\begin{abstract}
This problem is to demonstrate a method to find the equation of circles who touches both the axes and passes through a common point using matrix algebra.
\end{abstract}
