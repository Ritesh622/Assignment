...
\begin{abstract}
This document demonstrate if  the vectors are   orthogonal then they will  linear independent.
\end{abstract}
...
\begin{align}
c_1\vec{v_1}+c_2\vec{v_2}+c_3\vec{v_3}+ \dots +c_n\vec{v_n} = 0 \label{eq1}
\end{align}
