...
\begin{multline}
\textbf{T}\vec{\beta'}  = \vec{A}\beta'= \myvec{1 & 0 \\ 0 & 0 }\myvec{1 & -i \\ i & 2}=\myvec{ 1 & -i \\ 0 & 0} \label{2.1}
\end{multline}
...
\myvec{2 & 2i \\ -i & -1}
\end{align}
And this can also be represented using   $\beta$  and $\beta'$ 
\begin{align}
\textbf{T}\brak{\vec{\beta}}=\myvec{2&2i\\-i&-1}\vec{\beta^{'}}   
\end{align}
\end{document}