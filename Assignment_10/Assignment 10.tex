...
\begin{align}
\textbf{T} \vec{\alpha_1} = \vec{A}\vec{\alpha_1}= \myvec{1 & 0 \\ 0 & 0 }\myvec{1 \\ i}=\myvec{ 1  \\ 0} \label{2.1}\\
\textbf{T} \vec{\alpha_2} =\vec{A}\vec{\alpha_2}=\myvec{1 & 0 \\ 0 & 0 }\myvec{-i \\ 2}= \myvec{ -i  \\ 0} \label{2.2}
\end{align}
Now, for finding the matrix of \textbf{T} in the ordered basis $\ss'$,we combine the \ref{1}, \ref{2.1} and \ref{2.2} and  use concept of row-reduction of  the augmented matrix:
\begin{align}
