...
\section{solution}
 ...
 % We know that if any set which is forms  with  combination of two elements, and  if no two elements of $S$ have the same degree in $S$, then all elements in $S$ will be  independent set in $\mathbb{F}[x]$.\\
 \begin{align}
 \intertext{Since}
  1 \in S\\
 \intertext{and}
...
Subtracting $1.a^2 +2.a.b.x$ from $\brak{ax+b}^2$
 ...
 \end{align}
 Now, Thus  Hence using this concept with higher degree we can prove that, $ x^n \in  \left \langle S \right \rangle$  $\forall$  $ n $.\\
Consider,
 \begin{align}
